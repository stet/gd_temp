...
int main(int argc, char *argv[])
{
	...
	{
		command_main = &btk_vanity_main;
		command_requires_input = NULL;  // Vanity doesn't require input
		command_init = NULL;            // No special init needed
		command_cleanup = NULL;         // No special cleanup needed
	}
